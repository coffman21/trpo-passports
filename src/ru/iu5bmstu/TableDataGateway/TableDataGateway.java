...
public class TableDataGateway {
    ...
    public static void alter(String name, String dob, String gender, String city) throws SQLException {
        ...
        String nativeQ = "insert into passports (name, dob, gender, city, status) values ('" +
                name+ "', '"+
                dob+ "', '"+
                gender+ "', '"+
                city+ "', '"+
    ...
    public static ArrayList<Passport> selectWhere(boolean status) throws SQLException {
